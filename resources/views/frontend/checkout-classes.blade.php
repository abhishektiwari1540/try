        ...
        <div class="container">
            <div class="checkoutClasses">
                ...
                <div class="cart-coupon-bar">
                    ...
                    <a href="{{ route('front.classes')}}" class="default-btn">Continue Shopping</a>
                </div>
                            ...
                            <div id="payment" class=" woocommerce-checkout-payment">
                                ...
                                <div class="payment_method_paypal">
                                    <div class="form-group mb-0 custom_radio paypal-paycards">
                                        ...
                                        <div class="paypal-cards"><img src="{{ asset('frontend/img/paycards.jpg')}}"
                                ...
                                <div class="form-row place-order">
                                    <div class="conditions-wrapper">
                                            <p>Your personal data will be used to process your order, support your
                                                ...
                                                our privacy policy. <a href="{{ route('front.privacy_policy')}}"
