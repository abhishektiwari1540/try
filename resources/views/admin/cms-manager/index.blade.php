...
@section('content')
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.CMS_MANAGER.CMS_PAGES_TITLE') }}
                        </h5>
        ...
        <div class="d-flex flex-column-fluid">
            <div class=" container ">
                <form action="{{ route($modelName . '.index') }}" method="get" clas="kt-form kt-form--fit mb-0"
                    autocomplete="off">
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="text-uppercase">
                                                        ...
                                                        <th
                                                            class="{{ $sortBy == 'title' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'title' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                            <a
                                                                href="{{ route($modelName . '.index', [
                                                                    'sortBy' => 'title',
                                                        ...
                                                        <th
                                                            class="{{ $sortBy == 'body' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'body' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                            <a
                                                                href="{{ route($modelName . '.index', [
                                                                    'sortBy' => 'body',
                                                        ...
                                                        @foreach ($results as $result)
                                                            <tr>
                                                                ...
                                                                <td class="text-right pr-2">
                                                                    ...
                                                                    <!-- <a href="{{ route($modelName . '.destroy', base64_encode($result->id)) }}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
