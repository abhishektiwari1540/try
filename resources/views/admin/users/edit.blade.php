                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control form-control-solid form-control-lg  @error('name') is-invalid @enderror" value="{{$userDetails->name ?? '' }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" class="form-control form-control-solid form-control-lg  @error('email') is-invalid @enderror" value="{{$userDetails->email ?? '' }}">
                                            @if ($errors->has('email'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('email') }}
                                            </div>
