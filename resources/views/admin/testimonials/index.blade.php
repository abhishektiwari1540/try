                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE') }}
                        </h5>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <a href='{{ route("$model.create") }}' class="btn btn-primary">
                                            {{ trans('Add New ') }}{{ Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                                ...
                                                                <td class="text-right pr-2">
                                                                    ...
                                                                    @if ($result->is_active == 1)
                                                                        <a title="Click To Deactivate"
                                                                            href='{{ route("$model.status", [$result->id, 0]) }}'
                                                                    ...
                                                                    @else
                                                                        <a title="Click To Activate"
                                                                            href='{{ route("$model.status", [$result->id, 1]) }}'
                                                                    ...
                                                                    <a href="{{ route($model . '.delete', [base64_encode($result->id)]) }}"
