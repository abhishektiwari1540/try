                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE') }} Edit</h5>
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route($model . '.index') }}"
                                    class="text-muted">{{ Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="ckeditor form-control" name="description">{{ old('description', $userDetails->comments) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
