            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5"> {{ Config('constants.EVENTS.EVENTS_TITLE') }} Edit
                        </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-10">
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($userDetails->short_description !== null)
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                <label for="short_des">Short Description</label>
                                                <input type="text" name="short_des"
                                                    value="{{ $userDetails->short_description }}"
                                                    class="form-control form-control-solid form-control-lg @error('short_des') is-invalid @enderror">
                                                @error('short_des')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="ckeditor form-control" name="description">{{ old('description', $userDetails->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
