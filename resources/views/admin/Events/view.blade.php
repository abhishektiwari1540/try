                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.EVENTS.EVENTS_TITLE') }} Details
                        </h5>
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route($model . '.index') }}"
                                    class="text-muted">{{ Config('constants.EVENTS.EVENTS_TITLE') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="tab-content px-10">
                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder">{{ ucwords($eventDetails->slug ?? '') }}</span>
                                    </div>
                                </div>
                                @if (!is_null($eventDetails->short_description))
                                    <div class="form-group row my-2">
                                        <label class="col-4 col-form-label">Short Description:</label>
                                        <div class="col-8">
                                            <span
                                                class="form-control-plaintext font-weight-bolder">{{ $eventDetails->short_description ?? '' }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder">{!! $eventDetails->description ?? '' !!}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        @if (!empty($eventDetails->image))
                                            ...
                                            {{-- <img src="{{ asset($eventDetails->image) }}" width="100px" alt="Event Image"> --}}
                                        @else
