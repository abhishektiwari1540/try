                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.EVENTS.EVENTS_TITLE') }}
                        </h5>
...
@endphp --}}
        ...
        $createPermission = functionCheckPermission('EventsAdminController@create');
        $viewPermission = functionCheckPermission('EventsAdminController@view');
        $deletePermission = functionCheckPermission('EventsAdminController@delete');
        $statusPermission = functionCheckPermission('EventsAdminController@changeStatus');
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <a href='{{ route("$model.create") }}' class="btn btn-primary">
                                            {{ trans('Add New ') }}{{ Config('constants.EVENTS.EVENTS_TITLE') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
