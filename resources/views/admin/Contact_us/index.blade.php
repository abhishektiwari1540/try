                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.CONTACT.CONTACT_TITLE') }}
                        </h5>
                            ...
                            <div class="card card-custom card-stretch card-shadowless">
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        {{-- <a href='{{route("$model.create")}}' class="btn btn-primary">Add new {{Config('constants.STAFF.STAFF_TITLE')}} </a> --}}
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <div class="col-lg-3 mb-lg-5 mb-6">
                                                        ...
                                                        <div class="input-group date" id="datepickerfrom"
                                                            ...
                                                            <input type="text" class="form-control datetimepicker-input"
                                                                ...
                                                                value="{{ $searchVariable['date_from'] ?? '' }}">
                                                        ...
                                                        @foreach ($results as $result)
                                                            ...
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    ...
                                                                    {{-- <a href="{{route($model.'.changerpassword',['enstfid'=>base64_encode($result->id)])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Change Password">
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
