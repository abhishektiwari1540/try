                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route($model . '.index') }}" class="text-muted">
                                    {{ Config('constants.CLASS.CLASS_TITLE') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-10">
                                    <h3 class="mb-10 font-weight-bold text-dark">
                                        {{ Config('constants.CLASS.CLASS_TITLE') }} Information
                                    </h3>
                                    <div class="row">
                                        <div class="col-xl-6">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="contact_us_one_title"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label for="last_name">Contact Us Section Two Title</label><span
                                                    class="text-danger"> * </span>
                                                <input type="text" name="contact_us_two_title"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                <label for="email">Description</label><span class="text-danger"> *
                                                </span>
