                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.SYSTEM_DOCUMENT.SYSTEM_DOCUMENT_TITLE') }}
                        </h5>
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="{{ url('Admin/index') }}" class="text-muted">Dashboard</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
@endphp --}}
        ...
        $createPermission = functionCheckPermission('SystemDocmentController@create');
        $viewPermission = functionCheckPermission('SystemDocmentController@view');
        $deletePermission = functionCheckPermission('SystemDocmentController@delete');
        $statusPermission = functionCheckPermission('SystemDocmentController@changeStatus');
        ...
        <div class="d-flex flex-column-fluid">
            <div class=" container ">
                <form method="get" role="form" action="{{ route("$model.index") }}" class="kt-form kt-form--fit mb-0"
                    autocomplete="off">
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="row mb-6">
                                                    <div class="col-lg-3 mb-lg-5 mb-6">
                                                        ...
                                                        <select name="is_active" class="form-control select2init"
                                                            ...
                                                            <option value="1"
                                                                {{ isset($searchVariable['is_active']) && $searchVariable['is_active'] == 1 ? 'selected' : '' }}>
                                                                Activate</option>
                                                            <option value="0"
                                                                {{ isset($searchVariable['is_active']) && $searchVariable['is_active'] == 0 ? 'selected' : '' }}>
                                                                Deactivate</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-3 mb-lg-5 mb-6">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                            placeholder="Name" value="{{ $searchVariable['name'] ?? '' }}">
                                                    </div>

                                                    {{-- <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Email</label>
                                            <input type="text" class="form-control" name="email" placeholder="Email" value="{{$searchVariable['email'] ?? '' }}">
                                        </div> --}}
                                                    ...
                                                    <div class="col-lg-3 mb-lg-5 mb-6">
                                                        ...
                                                        <div class="input-group date" id="datepickerfrom"
                                                            ...
                                                            <input type="text" name="date_from"
                                                                value="{{ isset($searchVariable['date_from']) ? $searchVariable['date_from'] : '' }}"
                                                    ...
                                                    <div class="col-lg-3 mb-lg-5 mb-6">
                                                        ...
                                                        <div class="input-group date" id="datepickerto"
                                                            ...
                                                            <input type="text" name="date_to"
                                                                value="{{ isset($searchVariable['date_to']) ? $searchVariable['date_to'] : '' }}"
                                                                class="form-control datetimepicker-input"
                                    ...
                                    <div class="dataTables_wrapper ">
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="text-uppercase">
                                                        <th
                                                            class="{{ $sortBy == 'image' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'image' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                            <a
                                                        ...
                                                        <th
                                                            class="{{ $sortBy == 'is_active' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'is_active' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                            <a
                                                                href="{{ route($model . '.index', [
                                                                    'sortBy' => 'is_active',
                                                        ...
                                                        @foreach ($results as $result)
                                                            <tr>
                                                                ...
                                                                <td class="text-right pr-2">
                                                                    ...
                                                                    @if ($result->is_active == 1)
                                                                        {{-- <a  title="Click To Deactivate" href='{{route("$model.status",array($result->id,0))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
                                            ...
                                            @else
                                            <a title="Click To Activate" href='{{route("$model.status",array($result->id,1))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
                                                data-container="body" data-boundary="window"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            ...
                                                            <path d="M4.26193932,17.6476484 C3.90425297,18.0684559 3.27315905,18.1196257 2.85235158,17.7619393 C2.43154411,17.404253 2.38037434,16.773159 2.73806068,16.3523516 L11.2380607,6.35235158 C11.6013618,5.92493855 12.2451015,5.87991302 12.6643638,6.25259068 L17.1643638,10.2525907 C17.5771466,10.6195087 17.6143273,11.2515811 17.2474093,11.6643638 C16.8804913,12.0771466 16.2484189,12.1143273 15.8356362,11.7474093 L12.0997854,8.42665306 L4.26193932,17.6476484 Z" fill="#000000" fill-rule="nonzero" transform="translate(9.999995, 12.000002) rotate(-180.000000) translate(-9.999995, -12.000002) "/>
                                                                    ...
                                                                    <a href="{{ route($model . '.edit', [base64_encode($result->id)]) }}"
