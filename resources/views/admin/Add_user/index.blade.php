                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.INDIVIDUAL.INDIVIDUAL_TITLES') }}
                        </h5>
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{ route("$model.create") }}' class="btn btn-primary">
                                        {{ trans('Add New ') }}{{ Config('constants.INDIVIDUAL.INDIVIDUAL_TITLE') }}</a>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <input type="text" class="form-control" name="email"
                                                        placeholder="Email" value="{{ $searchVariable['email'] ?? '' }}">
                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                                    {{ ucfirst($result->first_name) ?? '' }}
                                                                    {{ ucfirst($result->last_name) ?? '' }}
                                                                </div>
                                                            </td>
