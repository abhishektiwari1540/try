...
class UsersController extends Controller
{
    ...
    public function create(Request $request) {       
        return  View("admin.$this->sectionNameSingular.add");
    }
    ...
    public function edit(Request $request,  $enuserid = null) { 
        ...
        if (!empty($enuserid)) {
            ...
            return  View("admin.$this->sectionNameSingular.edit", compact('userDetails'));
        } else {
            return redirect()->route($this->model . ".index");
        }
    }
    ...
    public function changedPassword(Request $request, $enuserid = null) {
        ...
        return view("admin.$this->sectionNameSingular.change_password", $data);
    }
