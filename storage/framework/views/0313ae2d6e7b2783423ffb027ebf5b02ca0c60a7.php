                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li
                                class="nav-item <?php echo e(request()->routeIs('front.events') || request()->segment(1) === 'events' ? 'active' : ''); ?>">
                            ...
                            <form id="language-form" method="POST" action="<?php echo e(route('front.langchange')); ?>">
                                <?php echo csrf_field(); ?>
                                <?php
                                ...
                                <li class="nav-item">
                                    <select class="selectpicker" data-width="fit" name="language" id="language-select">
                                        <?php $__currentLoopData = $lagaguage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                data-content='<span class="flag-icon flag-icon-us"><?php echo e($item->laguage_name ?? ''); ?></span>'
                                                class="language_select"<?php if($item->id == $lang_id): ?>Selected <?php endif; ?> value="<?php echo e($item->id ?? '1'); ?>"><?php echo e($item->laguage_name ?? ''); ?></option>
                            ...
                            <div class="dropdown-menu" aria-labelledby="user-drop">
                                <div class="user_info">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('front.logout')); ?>"><i class="ion-log-out"></i>
                                                Logout</a>
                                        </li>
                                    </ul>
                                </div>
...
<?php /**PATH C:\xamppa\htdocs\iraaspurohit_html\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>