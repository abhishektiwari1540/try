            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.STAFF.STAFF_TITLE')); ?>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='<?php echo e(route("$model.create")); ?>' class="btn btn-primary">Add new <?php echo e(Config('constants.STAFF.STAFF_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href="<?php echo e(route($model.'.changerpassword',['enstfid'=>base64_encode($result->id)])); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Change Password">
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/staff/index.blade.php ENDPATH**/ ?>