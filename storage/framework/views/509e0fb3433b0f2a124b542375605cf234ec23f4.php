                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown">
                                <!-- <a class="nav-link dropdown-toggle d-none d-lg-block" data-bs-toggle="dropdown"
                        ...
                        <div class="extra_nav">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item langugae_filter currency-filter for_desktop">
                                    <div class="dropdown">
                                        <button class="dropdown-toggle nav-link dropdown-toggle lang_drop"
                                            ...
                                            <span class="flag_ico"><img src="<?php echo e(asset('frontend/img/dollar.png')); ?>" alt=""></span> USD
                                        ...
                                        <ul class="dropdown-menu lang_dropdown">
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/dollar.png')); ?>" alt="">
                                                    </span> USD</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/JPY.png')); ?>" alt="">
                                                    </span> JPY
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/CHY.png')); ?>" alt="">
                                                    </span> CHY
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/Peso.png')); ?>" alt="">
                                                    </span> PESO
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link header_border_btn" href="<?php echo e(route('front.login')); ?>">Log in</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link header_filled_btn" href="<?php echo e(route('front.register')); ?>">Sign up</a>
                                </li>
                                ...
                                <li class="nav-item langugae_filter for_desktop">
                                    <div class="dropdown">
                                        <button class="dropdown-toggle nav-link dropdown-toggle lang_drop"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="flag_ico"><img src="<?php echo e(asset('frontend/img/en_flag.png')); ?>" alt=""></span> English
                                            <i class="far fa-chevron-down"></i>
                                        </button>
                                        <ul class="dropdown-menu lang_dropdown">
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/en_flag.png')); ?>" alt="">
                                                    </span> English</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/japanese.png')); ?>" alt="">
                                                    </span> Japanese
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/Chinese.png')); ?>" alt="">
                                                    </span> Chinese
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item lang_country" href="javascript:void(0)">
                                                    <span class="flag_ico">
                                                        <img src="<?php echo e(asset('frontend/img/Spanish.png')); ?>" alt="">
                                                    </span> Spanish
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <li class="nav-item langugae_filter">
                                <div class="dropdown">
                                    <button class="dropdown-toggle nav-link dropdown-toggle lang_drop" type="button"
                                        ...
                                        <span class="flag_ico"><img src="<?php echo e(asset('frontend/img/en_flag.png')); ?>" alt=""></span> En
                                        <i class="far fa-chevron-down"></i>
                                    </button>
                                    <ul class="dropdown-menu lang_dropdown">
                                        <li>
...
<?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/frontend/layouts/header2.blade.php ENDPATH**/ ?>