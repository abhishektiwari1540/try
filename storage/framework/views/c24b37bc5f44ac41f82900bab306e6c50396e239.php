...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						<?php echo e(Config('constants.EMAIL_LOGS.EMAIL_LOGS_TITLE')); ?>
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="<?php echo e(route($model.'.listEmail')); ?>" method="get" class="kt-form kt-form--fit mb-0 mws-form">
										...
										<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-0 mb-6">
													<label>Email</label>
													<input type="text" class="form-control" name="email_to" placeholder="Email From" value="<?php echo e($searchVariable->email_to ?? ''); ?>">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Mail Subject</label>
													<input type="text" class="form-control" name="subject" placeholder="Mail Subject" value="<?php echo e($searchVariable->subject ?? ''); ?>">
												</div>
												<div class="col-lg-3 mb-lg-5 mb-6">
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													&nbsp;&nbsp;
													<a href="<?php echo e(route($model.'.listEmail')); ?>" class="btn btn-secondary btn-secondary--icon">
														<span>
										...
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											<thead>
												<tr class="text-uppercase">
													<th class="<?php echo e((($sortBy == 'email_to' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'email_to' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.listEmail',array(	'sortBy' => 'email_to',
													'order' => ($sortBy == 'email_to' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>">Email To</a>
													</th>
													<th class="<?php echo e((($sortBy == 'email_from' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'email_from' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.listEmail',array(	'sortBy' => 'email_from',
													...
													<th class="<?php echo e((($sortBy == 'subject' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'subject' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.listEmail',array(	'sortBy' => 'subject',
													...
													<th class="<?php echo e((($sortBy == 'created_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'created_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.listEmail',array(	'sortBy' => 'created_at',
												...
												<tr>
													<td>
														<div class="text-dark-75 mb-1 font-size-lg">
															<?php echo e($data->email_to); ?>

														</div>
													</td>
													<td>
														<div class="text-dark-75 mb-1 font-size-lg">
															<?php echo e($data->email_from); ?>
													...
													<td>
														<div class="text-dark-75 mb-1 font-size-lg">
															<?php echo e(date(config("Reading.date_format"),strtotime($data->created_at))); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/emaillogs/index.blade.php ENDPATH**/ ?>