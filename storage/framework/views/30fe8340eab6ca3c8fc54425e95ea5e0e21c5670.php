                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            <?php echo e(Config('constants.CLASS.CLASS_TITLE')); ?>
                        ...
                        <div class="tab-content px-10">
                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder"><?php echo e($eventDetails->name_contact_us_frist ?? ''); ?></span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder"><?php echo e($eventDetails->name_contact_us_second ?? ''); ?></span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder"><?php echo $eventDetails->descriptions ?? ''; ?></span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/Class/view.blade.php ENDPATH**/ ?>