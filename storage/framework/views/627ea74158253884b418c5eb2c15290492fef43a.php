            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Add New <?php echo e(Config('constants.FAQ.FAQ_TITLE')); ?> </h5>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('faq_order')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('question')); ?>">
                                                    ...
                                                    <?php else: ?>
                                                    <label for="<?php echo e($language->id); ?>.question">Question</label><span class="text-danger"> </span>
                                                    <input type="text" name="data[<?php echo e($language->id); ?>][question]" class="form-control form-control-solid form-control-lg" value="<?php echo e(old('question')); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('answer')); ?>">
                                                    ...
                                                    <?php else: ?>
                                                    <label>Answer </label>
                                                    <textarea name="data[<?php echo e($language->id); ?>][answer]" id="body_<?php echo e($language->id); ?>" class="form-control form-control-solid form-control-lg"><?php echo e(old('answer')); ?></textarea>
                                                    <?php endif; ?>
                                                </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/faqs/add.blade.php ENDPATH**/ ?>