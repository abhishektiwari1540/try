	...
	function submit_form() {
		...
		$inputs.each(function() {
			if ($(this).val().trim() == '') {
				...
				}else if($(this).attr('id') == 'Contact.email_address') {
					if (!isEmail($(this).val().trim())) {
						$(this).next().html("Please enter a valid email");
						error = 1;
					} else {
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/settings/prefix.blade.php ENDPATH**/ ?>