                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            <?php echo e(Config('constants.SYSTEM_DOCUMENT.SYSTEM_DOCUMENT_TITLE')); ?>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="text-uppercase">
                                                        <th
                                                            class="<?php echo e($sortBy == 'image' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'image' && $order == 'asc' ? 'sorting_asc' : 'sorting')); ?>">
                                                            <a
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                                       <img src="<?php echo e($result->image ?? ''); ?>" alt=""></div>
                                                                </td>
                                                                <td>
                                                                    <div class="text-dark-75 mb-1 font-size-lg">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/system_documents/index.blade.php ENDPATH**/ ?>