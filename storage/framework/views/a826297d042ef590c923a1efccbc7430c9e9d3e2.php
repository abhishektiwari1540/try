...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<!-- <?php echo e(Str::studly($type)); ?>  -->
					<?php echo e(str_replace("-", " ", ucfirst($type))); ?> 	 Management </h5>			
					<ul
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
        <form action="<?php echo e(route($model.'.index',$type)); ?>" method="get" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
			<div class="row">
				<div class="col-12">
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<a href='<?php echo e(route("$model.add",$type)); ?>'  class="btn btn-primary"> <?php echo e(trans("Add New ")); ?><?php echo e(str_replace("-", " ", ucfirst($type))); ?>  </a>
							</div>
						</div>
						<div class="card-body">
									...
									<div>
											<div class="row mb-6">
												<div class="col-lg-3 mb-lg-5 mb-6">
													<label>Code</label>
                                                    <input type="text" class="form-control" name="code" placeholder="Code" value="<?php echo e($searchVariable['code'] ?? ''); ?>">
                                                </div>											
											</div>
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													&nbsp;&nbsp;												
													<a href="<?php echo e(route($model.'.index',$type)); ?>" class="btn btn-secondary btn-secondary--icon">
														<span>
								...
								<div class="table-responsive">
									<table
										...
										<thead>
                                            ...
                                            <th class="<?php echo e((($sortBy == 'code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',$type,array(	'sortBy' => 'code',
                                                    ...
                                                    <th class="<?php echo e((($sortBy == 'created_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'created_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',$type,array(	'sortBy' => 'created_at',
                                                    ...
                                                    <th class="<?php echo e((($sortBy == 'is_active' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'is_active' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',$type,array(	'sortBy' => 'is_active',
											...
											<?php if(!$results->isEmpty()): ?>
												<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
                                                        ...
                                                        <?php endif; ?>
														<a href="<?php echo e(route($model.'.edit',array($type,base64_encode($result->id)))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
															...
															<a href="<?php echo e(route($model.'.delete',['enlokid'=>base64_encode($result->id)])); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
                                                            <span class="svg-icon svg-icon-md svg-icon-danger">
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.dev.obdemo.com/public_html/resources/views/admin/lookups-manager/index.blade.php ENDPATH**/ ?>