										...
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group">
													<?php if($i == 1): ?>
													<label name="<?php echo e($language->id); ?>.'.name'">Name</label><span class="text-danger"> * </span>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($multiLanguage[$language->id]['name'] ?? ''); ?>">
													...
													<?php endif; ?>
													<?php else: ?>
													<label name="data<?php echo e($language->id); ?>.'.name'">Name</label><span class="text-danger"> * </span>
											...
											<div class="col-xl-6">
												<div class="form-group">
													<?php if($i == 1): ?>
													<label name="<?php echo e($language->id); ?>.'.subject'">Subject</label><span class="text-danger"> * </span>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($multiLanguage[$language->id]['subject'] ?? ''); ?>">
													...
													<?php else: ?>
													<label name="<?php echo e($language->id); ?>.'.subject'">Subject</label><span class="text-danger"> * </span>
													<input type="text" name="data[<?php echo e($language->id); ?>][subject]" class="form-control form-control-solid form-control-lg " value="<?php echo e($multiLanguage[$language->id]['subject'] ?? ''); ?>">
													<?php endif; ?>
												</div>
											</div>
											<div class="col-xl-6" style="display:none;">
												<div class="form-group">
													...
													<select name="data[<?php echo e($language->id); ?>][action]" class="form-control form-control-solid form-control-lg" id="action">
											...
											<div class="col-xl-6">
												<div class="form-group">
													...
													<div class="row">
														<div class="col">
															<select name="constants" class="form-control form-control-solid form-control-lg" onchange="constants($i)" id="constants_<?php echo e($i); ?>">
														...
														<div class="col-auto">
															<a onclick="return InsertHTML(<?php echo $i ?>)" href="javascript:void(0)" class="btn btn-lg btn-success no-ajax pull-right"><i class="icon-white "></i><?php echo e(trans("Insert Variable")); ?> </a>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xl-12">
												<div class="form-group">
													...
													<?php if($i == 1): ?>
													<label for="<?php echo e($language->id); ?>.'.body'">Email Body </label><span class="text-danger"> * </span>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('body')); ?>">
													<?php echo e($multiLanguage[$language->id]['body'] ?? ''); ?> </textarea>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/email-templates/edit.blade.php ENDPATH**/ ?>