			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						<?php echo e(Config('constants.SETTING.SETTINGS_TITLE')); ?>
						...
						<div class="card card-custom card-stretch card-shadowless">
							<div class="card-header">
								...
								<div class="card-toolbar">
									...
									<a href="<?php echo e(route($model.'.create')); ?>" class="btn btn-primary"> <?php echo e('Add New '); ?><?php echo e(Config('constants.SETTING.SETTING_TITLE')); ?> </a>
								</div>
							</div>
							<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
											<thead>
												...
												<tr class="text-uppercase">
													<th class="<?php echo e((($sortBy == 'id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'id',
													...
													<th class="<?php echo e((($sortBy == 'key' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'key' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'key',
													'order' => ($sortBy == 'key' && $order == 'desc') ? 'asc' : 'desc',	
													))); ?>">Key</a>
													</th>
													<th class="<?php echo e((($sortBy == 'value' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'value' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
														<a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'value',
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="<?php echo e(route($model.'.edit',base64_encode($record->id))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
														...
														<a href="<?php echo e(route($model.'.delete',base64_encode($record->id))); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.dev.obdemo.com/public_html/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>