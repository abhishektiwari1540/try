        ...
        <div class="login-container d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid p-8">
            <div class="login-content d-flex flex-column card p-5 p-md-10">
                <a href="<?php echo e(route('adminpnlx')); ?>" class="login-logo pb-8 text-center">
                    <img src="<?php echo e(asset('/img/logo.png')); ?>" class="max-h-80px" alt="" />
                </a>
...
<?php echo $__env->make('admin.layouts.login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/login/forget_password.blade.php ENDPATH**/ ?>