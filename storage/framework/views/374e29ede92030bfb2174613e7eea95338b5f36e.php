                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            <?php echo e(Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE')); ?>
                            ...
                            <div class="card card-custom card-stretch card-shadowless">
                                <div class="card-header">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <a href='<?php echo e(route("$model.create")); ?>' class="btn btn-primary">
                                            <?php echo e(trans('Add New ')); ?><?php echo e(Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE')); ?></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                                ...
                                                                <td class="text-right pr-2">
                                                                    ...
                                                                    <?php if($result->is_active == 1): ?>
                                                                        <a title="Click To Deactivate"
                                                                            href='<?php echo e(route("$model.status", [$result->id, 0])); ?>'
                                                                    ...
                                                                    <?php else: ?>
                                                                        <a title="Click To Activate"
                                                                            href='<?php echo e(route("$model.status", [$result->id, 1])); ?>'
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/testimonials/index.blade.php ENDPATH**/ ?>