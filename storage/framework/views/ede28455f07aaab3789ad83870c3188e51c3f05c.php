            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                       <?php echo e(Config('constants.CUSTOMER.CUSTOMERS_TITLES')); ?>
...
<div class="d-flex flex-column-fluid">
    <div class=" container ">
        <?php echo e(Form::open(['method' => 'get','role' => 'form','route' => "$model.index",'class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"])); ?>
                ...
                <div class="card card-custom card-stretch card-shadowless">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href='<?php echo e(route("$model.create")); ?>' class="btn btn-primary"> <?php echo e(trans("Add New ")); ?><?php echo e(Config('constants.CUSTOMER.CUSTOMERS_TITLE')); ?></a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div>
                                    <div class="row mb-6">
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Status</label>
                                            <select name="is_active" class="form-control select2init" value="<?php echo e($searchVariable['is_active'] ?? ''); ?>">
                                                <option value="">All</option>
                                                <option value="1" <?php echo e(isset($searchVariable['is_active']) && $searchVariable['is_active'] == 1 ? 'selected': ''); ?> >Activate</option>
                                                <option value="0" <?php echo e(isset($searchVariable['is_active']) && $searchVariable['is_active'] == 0 ? 'selected': ''); ?> >Deactivate</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Name</label>
                                            <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo e($searchVariable['name'] ?? ''); ?>">
                                        </div>

                                        <div class="col-lg-3 mb-lg-5 mb-6">
                                            <label>Email</label>
                                            <input type="text" class="form-control" name="email" placeholder="Email" value="<?php echo e($searchVariable['email'] ?? ''); ?>">
                                        </div>
                                        ...
                                        <tr class="text-uppercase">
                                         ...
                                         <th class="<?php echo e((($sortBy == 'created_at' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'created_at' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                            <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'created_at',
                                             ...
                                             $query_string))); ?>"> Registered On</a>
                                         </th> 
                                         <th class="<?php echo e((($sortBy == 'is_active' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'is_active' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                            <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'is_active',
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right pr-2">
                                            ...
                                            <?php if($result->is_active == 1): ?>
                                            <a  title="Click To Deactivate" href='<?php echo e(route("$model.status",array($result->id,0))); ?>' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <?php else: ?>
                                            <a title="Click To Activate" href='<?php echo e(route("$model.status",array($result->id,1))); ?>' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
                                                data-container="body" data-boundary="window"
                                            ...
                                            <a href="<?php echo e(route($model.'.edit',array(base64_encode($result->id)))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
                                            ...
                                            <a href="<?php echo e(route($model.'.show',array(base64_encode($result->id)))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="View" data-original-title="View">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24"
                                                    version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24" />
                                            ...
                                            <a href="<?php echo e(route($model.'.delete',array(base64_encode($result->id)))); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
                                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24" />
                                            ...
                                            <a href="<?php echo e(route($model.'.changedPassword',array(base64_encode($result->id)))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Change Password" data-original-title="Change Password">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                            ...
                                            <a href='<?php echo e(URL::to("adminpnlx/customers/send-credentials","$result->id")); ?>' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Send Credentials" data-original-title="Send Credentials">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.stage02.obdemo.com/public_html/resources/views/admin/users/index.blade.php ENDPATH**/ ?>