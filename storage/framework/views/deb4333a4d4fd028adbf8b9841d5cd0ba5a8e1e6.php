...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title')); ?>">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label for="short_des">Short description</label><span class="text-danger"> * </span>
                                            <input type="text" name="short_des" class="form-control form-control-solid form-control-lg  <?php $__errorArgs = ['short_des'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('short_des')); ?>">
                                            <?php if($errors->has('short_des')): ?>
                                            <div class=" invalid-feedback">
                                                <?php echo e($errors->first('short_des')); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/events/add.blade.php ENDPATH**/ ?>