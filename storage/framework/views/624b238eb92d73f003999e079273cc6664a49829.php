                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            <?php echo e(Config('constants.TESTIMONIALS.TESTIMONIALS_TITLE')); ?> Edit</h5>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="ckeditor form-control" name="description"><?php echo e(old('description', $userDetails->comments)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/admin/testimonials/edit.blade.php ENDPATH**/ ?>