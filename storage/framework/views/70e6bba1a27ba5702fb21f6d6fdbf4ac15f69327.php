	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group row my-2">
						...
						<div class="col-12">
							<span class="font-size-sm text-muted font-weight-bold mt-1r"><?php echo e($result->email_to); ?></span>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="form-group row my-2">
						...
						<div class="col-12">
							<span class="font-size-sm text-muted font-weight-bold mt-1r"><?php echo e($result->email_from); ?></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group row my-2">
				...
				<div class="col-12">
					<span class="font-size-sm text-muted font-weight-bold mt-1r"><?php echo e($result->subject); ?></span>
				</div>
			</div>
			<hr>
			<div class="form-group row my-2">
...
</div><?php /**PATH /home/wildtag/web/wildtag.dev.obdemo.com/public_html/resources/views/admin/emaillogs/popup.blade.php ENDPATH**/ ?>