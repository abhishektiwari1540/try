<?php $__env->startSection('content'); ?>
    ...
    <section class="page-content privacy-page">
        <div class="container">
            ...
            <h1 class="page-title"><?php echo e($page_data['page_name']); ?></h1><?php echo $page_data['body']; ?>Email :<a href="mailto:<?php echo e($setting['email_address']); ?>" style="text-decoration: underline;"><?php echo e($setting['email_address']); ?></a><br>
            <form class="privacy-form" method="POST" id="contact_form" action="<?php echo e(route('front.contact')); ?>"
                ...
                <div class="row g-md-4">
                    ...
                    <button type="button" data-sitekey="<?php echo e(env('GOOGLE_CAPTCHA_SITE_KEY')); ?>" data-callback='onSubmit'
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/frontend/privacy-policy.blade.php ENDPATH**/ ?>