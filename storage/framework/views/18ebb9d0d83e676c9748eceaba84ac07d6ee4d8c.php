                    ...
                    <div class="formCard mw-100">
                        ...
                        <div class="thanks-page">
                            ...
                            <div class="loginbtn-block">
                                <a href="<?php echo e(route('front.login_page')); ?>" class="default-btn">
                                    Login Now
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/frontend/Auth/register-thank.blade.php ENDPATH**/ ?>