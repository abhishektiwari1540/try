...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="<?php echo e(asset('frontend/img/favicon/android-icon-192x192.png')); ?>">
...
<body>
    ...
    <?php if(request()->segment(1) === 'elements'): ?>
        <?php echo $__env->make('frontend.layouts.header2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
    ...
    <?php if(Session::has('message_login')): ?>
    <script>
        $(document).ready(function() {
            toastr.success('<?php echo e(Session::get('message_login')); ?>');
            setTimeout(function() {
                <?php
...
<?php /**PATH /home/ymp/web/ymp.dev.obdemo.com/public_html/resources/views/frontend/layouts/master.blade.php ENDPATH**/ ?>