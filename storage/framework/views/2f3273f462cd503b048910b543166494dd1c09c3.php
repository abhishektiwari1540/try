...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($userDetails->username ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($userDetails->email ?? ''); ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="<?php echo e($userDetails->phone_prefix ?? +971); ?>" name="phone_prefix" class="phone_prefix">
                                            <input type="hidden" value="<?php echo e($userDetails->phone_code ?? 'ae'); ?>" name="phone_code" class="phone_code">
                                            <input type="text"  name="phone_number" onkeypress="return /[0-9]/i.test(event.key)" class="form-control form-control-solid form-control-lg phone_numbers" value="<?php echo e($userDetails->phone_number ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($country->id); ?>" <?php echo e($country->id==$userDetails->country ? 'selected' : ''); ?>><?php echo e($country->name); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <?php $__currentLoopData = $ages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $age): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($age->id); ?>" <?php echo e($age->id == $userDetails->age_id ? 'selected' : ''); ?>><?php echo e($age->code); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wildtag/web/wildtag.dev.obdemo.com/public_html/resources/views/admin/individuals/edit.blade.php ENDPATH**/ ?>